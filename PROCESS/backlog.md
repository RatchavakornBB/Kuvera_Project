...
## Ready
- [ ] phase1-007-table-pipeline-view — Table view + Pipeline funnel strip + filter bar + New Deal button (ux-ui-spec.md Section 3.1).
- [ ] phase4-001-deal-detail — convert Deal Detail shell + Overview/Documents/Analysis/Tasks tabs, wire to real /deals/{id}, /analyze, /contracts data.
